...
//                                      });
                            ...
                            onTap: () {
                              ...
                              decoration: BoxDecoration(
                                color: _isRecordingMode ? Colors.redAccent : Colors.white,
                                borderRadius: BorderRadius.all(
                                  Radius.circular(30),
                                ),
                              ),
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                width: 10,
                                color: _isRecordingMode ?  Colors.red.withOpacity(.4)  :  Colors.white.withOpacity(.5),
                              ),
                            ),
                          ),
                          Container(
                          //  padding: const EdgeInsets.all(10),
                            ...
                            child: GestureDetector(
                              ...
                              child: Icon(Icons.cached,size: 40,),
                            ),
                          ),
